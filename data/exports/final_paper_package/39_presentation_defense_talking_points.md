...
**2. The "Headline"**:
In our primary 16-ticker baseline, we find a statistically significant 5-day abnormal return of **0.52% (p=0.001)**. This result holds even when we filter for upload timing, exclude events near official SEC filings (SEC-clean n=716, mean=0.80%), and apply broad public news filters (Free-News clean, n=267, mean=0.003%).
