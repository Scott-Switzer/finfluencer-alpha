...
The extreme sensitivity to transaction costs and the dependency on duplicate "echo" videos further imply that while the social media signal is real, it does not represent a viable path to tradable excess returns. The phenomenon is best characterized as **attention amplification**—a digital-age extension of momentum that is consistent with behavioral theories of retail attention driving short-term price pressure in high-profile stocks.
