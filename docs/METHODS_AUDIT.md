...
Frontier pass: pre-event selection regressions, attention amplification, reversal panels, creator taxonomy, transcript language scores (evidence_window only), expanded placebos, and time-split predictive validity.
